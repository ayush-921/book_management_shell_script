	...
	case $choice in
		...
		4)
			...
			while [ -z "$author" ]; do
				...
				echo -e "Enter the author name: \c"
				read author
			done
			echo "------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
			awk -F ":" '{ printf "%-35s%-35s%-25s%-25s%-25s%-25s%-12s|\n", $1, $2, $3, $4, $5, $6, $7}' formatter.txt
			echo "------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" 
			awk -F ":" -v author="$author" '$3 ~ author { printf "%-35s%-35s%-25s%-25s%-25d%-25d%-15s|\n", $1, $2, $3, $4, $5, $6, $7}' books.data 
			;;
		5)
			...
			awk -F ":" '{ printf "%-35s%-35s%-25s%-25s%-25s%-25s%-12s|\n", $1, $2, $3, $4, $5, $6, $7}' formatter.txt
			echo "------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" 
			awk -F ":" -v book_name="$book_name" '$2 ~ book_name { printf "%-35s%-35s%-25s%-25s%-25d%-25d%-15s|\n", $1, $2, $3, $4, $5, $6, $7}' books.data 
			;;
